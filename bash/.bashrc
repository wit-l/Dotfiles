# $XDG_CONFIG_HOME/.bashrc: executed by bash(1) for non-login shells.
...
# $XDG_CONFIG_HOME/.bash_aliases, instead of adding them here directly.
...
#   fi
# fi
[ -f $XDG_CONFIG_HOME/.fzf.bash ] && source $XDG_CONFIG_HOME/.fzf.bash
