...
-- local shada_file = xdg_state_home .. '/nvim/shada/main.shada'
-- vim.opt.shada = shada_file
...
vim.keymap.set({ 'i', 'c' }, 'jf', '<Esc>', { desc = 'Enter Normal mode' })
vim.keymap.set('n', '<leader>x', '<cmd>q!<CR>', { desc = 'Exit the file' })
